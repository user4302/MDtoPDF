...
import { generatePrintStyles } from '@/lib/print-styles';
import { generatePlaceholderText } from '@/lib/placeholder-text';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">Markdown to PDF Converter v{packageJson.version}</h1>
